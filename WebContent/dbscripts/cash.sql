-- Changed the selection of CASH_BALANCE in DOM_SALES_INVOICES_TRIG and in DOM_SALES_INVOICES_UPDATE_TRIG triggers. And need to update in all triggers.
...
INSERT INTO CASH_TRANS_ENUM (ID, TRANS_MODULE) VALUES (4,'CASH WITHDRAWAL');
...
BEGIN
   ...
   then
   SET @Y = NEW.RCP_AMOUNT + (SELECT CASH_BALANCE FROM AGENCY_CASH_DATA WHERE CREATED_BY = NEW.CREATED_BY and T_DATE <= NEW.RCP_DATE and TRANS_TYPE != 11 order by ID desc limit 1);
...
BEGIN
   if  NEW.PAYMENT_MODE = 1 && NEW.CREDITED_BANK = 1
   then
   SET @Y = NEW.RCP_AMOUNT + (SELECT CASH_BALANCE FROM AGENCY_CASH_DATA WHERE CREATED_BY = NEW.CREATED_BY and T_DATE <= NEW.RCP_DATE and TRANS_TYPE != 11 order by T_DATE desc, ID desc limit 1);
   INSERT INTO AGENCY_CASH_DATA(INV_NO,TRANS_TYPE,T_DATE,CASH_AMOUNT,CASH_BALANCE,CREATED_BY,CREATED_DATE,MODIFIED_BY,MODIFIED_DATE,VERSION,DELETED) VALUES(NEW.SR_NO,2, NEW.RCP_DATE, NEW.RCP_AMOUNT,@Y,NEW.CREATED_BY,NEW.CREATED_DATE,0,0,1,0);
   end if;
END;
|
...
BEGIN
   ...
   then
   SET @X = (SELECT CASH_BALANCE FROM AGENCY_CASH_DATA WHERE CREATED_BY = NEW.CREATED_BY and T_DATE <= NEW.PYMT_DATE and TRANS_TYPE != 11 order by T_DATE desc, ID desc limit 1) - NEW.PYMT_AMOUNT ;
...
BEGIN
   ...
   if  NEW.TRANS_TYPE = 4
   then
   SET @X = (SELECT CASH_BALANCE FROM AGENCY_CASH_DATA WHERE CREATED_BY = NEW.CREATED_BY and T_DATE <= NEW.BT_DATE and TRANS_TYPE != 11 order by T_DATE desc, ID desc limit 1) + NEW.TRANS_AMOUNT ;
...
BEGIN
   ...
   if  NEW.TRANS_TYPE = 4
   then
   SET @X = (SELECT CASH_BALANCE FROM AGENCY_CASH_DATA WHERE CREATED_BY = NEW.CREATED_BY and T_DATE <= NEW.BT_DATE and TRANS_TYPE != 11 order by ID desc limit 1) + NEW.TRANS_AMOUNT ;
   		INSERT INTO AGENCY_CASH_DATA(INV_NO,TRANS_TYPE,T_DATE,CASH_AMOUNT,CASH_BALANCE,CREATED_BY,CREATED_DATE,MODIFIED_BY,MODIFIED_DATE,VERSION,DELETED) VALUES(NEW.SR_NO,4, NEW.BT_DATE, NEW.TRANS_AMOUNT,@X,NEW.CREATED_BY,NEW.CREATED_DATE,0,0,1,0);
   end if;
...
BEGIN
   ...
   then
   SET @Y = NEW.CASH_AMOUNT + (SELECT CASH_BALANCE FROM AGENCY_CASH_DATA WHERE CREATED_BY = NEW.CREATED_BY and T_DATE <= NEW.SI_DATE and TRANS_TYPE != 11 order by T_DATE desc, ID desc limit 1);
   INSERT INTO AGENCY_CASH_DATA(INV_NO,TRANS_TYPE,T_DATE,CASH_AMOUNT,CASH_BALANCE,CREATED_BY,CREATED_DATE,MODIFIED_BY,MODIFIED_DATE,VERSION,DELETED,DISCOUNT) VALUES(NEW.SR_NO,8, NEW.SI_DATE, NEW.CASH_AMOUNT,@Y,NEW.CREATED_BY,NEW.CREATED_DATE,0,0,1,0,NEW.DISCOUNT);
   end if;
END;
|
delimiter ;
...
BEGIN
   if  NEW.PAYMENT_TERMS = 1 
   then
   SET @Y = NEW.SI_AMOUNT + (SELECT CASH_BALANCE FROM AGENCY_CASH_DATA WHERE CREATED_BY = NEW.CREATED_BY and T_DATE <= NEW.SI_DATE and TRANS_TYPE != 11 order by T_DATE desc, ID desc limit 1);
   INSERT INTO AGENCY_CASH_DATA(INV_NO,TRANS_TYPE,T_DATE,CASH_AMOUNT,CASH_BALANCE,CREATED_BY,CREATED_DATE,MODIFIED_BY,MODIFIED_DATE,VERSION,DELETED,DISCOUNT) VALUES(NEW.SR_NO,8, NEW.SI_DATE, NEW.SI_AMOUNT,@Y,NEW.CREATED_BY,NEW.CREATED_DATE,0,0,1,0,NEW.DISCOUNT);
   end if;
END;
|
delimiter ;
...
BEGIN
   ...
   then
   SET @Y = NEW.CASH_AMOUNT + (SELECT CASH_BALANCE FROM AGENCY_CASH_DATA WHERE CREATED_BY = NEW.CREATED_BY and T_DATE <= NEW.INV_DATE and TRANS_TYPE != 11 order by T_DATE desc, ID desc limit 1);
...
BEGIN
   if  NEW.RC_AMOUNT != 0 
   then
   SET @Y = NEW.RC_AMOUNT + (SELECT CASH_BALANCE FROM AGENCY_CASH_DATA WHERE CREATED_BY = NEW.CREATED_BY and T_DATE <= NEW.RC_DATE and TRANS_TYPE != 11 order by T_DATE desc, ID desc limit 1);
...
BEGIN
   if  NEW.TV_AMOUNT != 0 
   then
   SET @Y = (SELECT CASH_BALANCE FROM AGENCY_CASH_DATA WHERE CREATED_BY = NEW.CREATED_BY and T_DATE <= NEW.TV_DATE and TRANS_TYPE != 11 order by T_DATE desc, ID desc limit 1)-NEW.TV_AMOUNT ;
...
/*ASSETS MANAGEMENT INSERT*/  -----------------------DROPPED-ADDED CODE
delimiter |
...
BEGIN
   ...
   then
   SET @Y = NEW.ASSET_VALUE + (SELECT CASH_BALANCE FROM AGENCY_CASH_DATA WHERE CREATED_BY = NEW.CREATED_BY and T_DATE <= NEW.ASSET_TDATE and TRANS_TYPE != 11 order by T_DATE desc, ID desc limit 1);
...
BEGIN
   ...
   -- At the time of delete only one record(this one record wll get added at the time of saving) will be there in cash table with that inv_no
   
   if  NEW.PAYMENT_TERMS = 1 && @C = 1 && NEW.DELETED = 2
   then
   SET @D = unix_timestamp(now()) * 1000;
   SET @Y =  (SELECT CASH_BALANCE FROM AGENCY_CASH_DATA WHERE CREATED_BY = NEW.CREATED_BY and T_DATE <= @D and TRANS_TYPE != 11 order by ID desc limit 1) - NEW.CASH_AMOUNT;
   INSERT INTO AGENCY_CASH_DATA(INV_NO,TRANS_TYPE,T_DATE,CASH_AMOUNT,CASH_BALANCE,CREATED_BY,CREATED_DATE,MODIFIED_BY,MODIFIED_DATE,VERSION,DELETED) VALUES(NEW.SR_NO,9, NEW.SI_DATE, NEW.CASH_AMOUNT,@Y,NEW.CREATED_BY,NEW.CREATED_DATE,0,0,1,0);
   end if;
END;
|
...
BEGIN
   ...
   then
   SET @D = unix_timestamp(now()) * 1000;
   SET @Y = (SELECT CASH_BALANCE FROM AGENCY_CASH_DATA WHERE CREATED_BY = NEW.CREATED_BY and T_DATE <= @D and TRANS_TYPE != 11 order by ID desc limit 1) - NEW.SI_AMOUNT ;
   INSERT INTO AGENCY_CASH_DATA(INV_NO,TRANS_TYPE,T_DATE,CASH_AMOUNT,CASH_BALANCE,CREATED_BY,CREATED_DATE,MODIFIED_BY,MODIFIED_DATE,VERSION,DELETED) VALUES(NEW.SR_NO,9, NEW.SI_DATE, NEW.SI_AMOUNT,@Y,NEW.CREATED_BY,NEW.CREATED_DATE,0,0,1,0);
   end if;
END;
|
...
/*ASSETS MANAGMENT UPDATE*/  ---------------------------DROPPED
delimiter |
...
/*   
/*BANKTRANSACTIONS UPDATE*/  ----------------------------DROPPED
delimiter |
CREATE  TRIGGER BANK_TRANS_DATA_DELETE_TRIG
    BEFORE UPDATE ON BANK_TRANS_DATA
    FOR EACH ROW
BEGIN
   SET @C =  (SELECT COUNT(*) FROM AGENCY_CASH_DATA WHERE CREATED_BY = OLD.CREATED_BY and INV_NO = OLD.SR_NO);
   
   if  OLD.TRANS_TYPE = 4 && @C = 1 && NEW.DELETED = 2
   then
   SET @D = unix_timestamp(now()) * 1000;
   SET @X = (SELECT CASH_BALANCE FROM AGENCY_CASH_DATA WHERE CREATED_BY = OLD.CREATED_BY and T_DATE <= @D and TRANS_TYPE != 11 order by ID desc limit 1) - OLD.TRANS_AMOUNT ;
   ...
   if  OLD.TRANS_TYPE = 3 && @C = 1 && NEW.DELETED = 2
   then
   SET @D = unix_timestamp(now()) * 1000;
   SET @X = (SELECT CASH_BALANCE FROM AGENCY_CASH_DATA WHERE CREATED_BY = OLD.CREATED_BY and T_DATE <= @D and TRANS_TYPE != 11 order by ID desc limit 1) + OLD.TRANS_AMOUNT ;
