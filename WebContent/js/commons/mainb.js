...
//		$(".hddoms").addClass('headerds');
		...
		$(".hmalrts").addClass('hmalrtsnews_collapse');
		$(".hmnws").addClass('hmalrtsnews_collapse');
...
//			$(".headerds").css("margin-left","-35px");
			...
			$(".hmalrtsnews_collapse").css("width","130%");
			$(".hmalrtsnews_collapse").css("margin-left","-171px");
...
//			$(".headerds").css("margin-left","-17px");
			...
			$(".hmalrtsnews_collapse").css("width","122%");
			$(".hmalrtsnews_collapse").css("margin-left","-152px");
		}else {
//			$(".headerds").css("margin-left","-17px");
			$(".headerop").css("margin-left","-23px");
			$(".hmwbox_collapse").css("margin-left","4%");
			$(".hmalrtsnews_collapse").css("margin-left","-45px");
		}
	}else {
...
//			$(".hmwbox_collapse").css("margin-left","1%");
			$(".hmalrtsnews_collapse").css("margin-left","-25px");
			$(".hmalrtsnews_collapse").css("width","115%");
		}else if((window.screen.width < 1400) && (window.screen.width > 1024)) {
			...
			$(".hmalrtsnews_collapse").css("margin-left","-53px");
			$(".hmalrtsnews_collapse").css("width","107%");
			...
			$(".hmalrtsnews_collapse").css("margin-left","-100px");
		}
...
//		$(".hddoms").removeClass('headerds');
		...
		$(".hmalrts").removeClass('hmalrtsnews_collapse');
		$(".hmnws").removeClass('hmalrtsnews_collapse');
...
//								$(".headerds").css("margin-left","-35px");
								...
								$(".hmwbox_collapse").css("margin-left","-120px");
								$(".hmalrtsnews_collapse").css("width","130%");
								$(".hmalrtsnews_collapse").css("margin-left","-202px");
							}else if((window.screen.width < 1400) && (window.screen.width > 1024)) {
//								$(".headerds").css("margin-left","-17px");
								$(".headerop").css("margin-left","-23px");
								$(".hmwbox_collapse").css("margin-left","30px !important");
								$(".hmalrtsnews_collapse").css("width","122%");
								$(".hmalrtsnews_collapse").css("margin-left","-104px");
							}else {
//								$(".headerds").css("margin-left","-17px");
								$(".headerop").css("margin-left","-23px");
								$(".hmwbox_collapse").css("margin-left","4%");
