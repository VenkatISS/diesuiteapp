...
function addRow() {
	...
	if(ele.length<4){
		...
		k.innerHTML = "<td valign='top' height='4' align='center'><img src='images/delete.png' onclick='doRowDeleteInTranxs(this,namt,sr_t_amt,data_table_body)'></td>";
...
//					eproduct,egst,erqty,enw,eur,etxblamt,eigsta,ecgsta,esgsta,enamt,pname);
			ems = validateEntries(einvReNo,einvDate,ecust,einvamt,enar,
					eproduct,egst,erqty,enw,eur,etxblamt,eigsta,ecgsta,esgsta,enamt);
		} else if (elements.length > 1) {
			for (var i = 0; i < elements.length; i++) {
...
//					return "The quantity of "+pname+" you entered exceeds the sold quantity as you have already received some of this sold product ";
					return "The quantity of you entered exceeds the sold quantity as you have already received some of this sold product ";
				}
			}else {
				var estock,astock;
...
//								return "The Equipment of "+pname+" you are trying to return is out of stock.Please Check and add again";
								return "The Equipment of you are trying to return is out of stock.Please Check and add again";
							}
						}
					}
...
//								return "The BLPG/ARB/NFR of "+pname+" item you are trying to return is out of stock.Please Check and add again";
								return "The BLPG/ARB/NFR of item you are trying to return is out of stock.Please Check and add again";
							}
						}
					}
				}
...
function validateEntries(invReNo,invDate,cust,invamt,nar,product,gst,rqty,nw,ur,txblamt,igsta,cgsta,sgsta,enamt) {
...
/*			switch (parseInt(pidv)) {
			...
			var ems = validateCalcValues(pidv,vpv,nwv,urv,rq,ptypecheck,ptypev,pname);
*/
