...
//		var o = newRow.insertCell(14);
		...
		a.innerHTML = "<td><select name='epid' id='epid' class='form-control input_field select_dropdown sadd pid'>"+ctdatahtml+"</select></td>";
		...
		n.innerHTML = "<td><img src='images/delete.png' onclick='doRowDeleteInTranxs(this,siamt,si_amt,data_table_body)'></td>"+
							"<td>"+
