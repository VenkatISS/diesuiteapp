...
function saveData(obj){
	...
	if(document.getElementById("epid") != null){
		...
		ems = validateEntries(nidate,cvtype,crefno,cvoid,item,egst,tamt,igst,cgst,sgst,camt);
	}else {
...
*/
function validateEntries(nidate,cvtype,crefno,cvoid,item,egst,tamt,igst,cgst,sgst,camt) {
