...
function changeBank() {
	...
	if(emop == 1) {
		...
		document.getElementById("charges").value = 0.00;
...
//			var erfrom = formobj.rfrom.selectedIndex;
			...
			ems = validateRCPTEntries(erdate, eramt, erfrom, emop, einstrd,ebid, esid, enar, chrg);

			var chrg1 = formobj.charges.value.trim();
...
function validateRCPTEntries(rdate, ramt, rfrom, mop, instrd, bid, sid, nar, chrg) {
	var errmsg = "";
	var formobj = document.getElementById('page_data_form');
