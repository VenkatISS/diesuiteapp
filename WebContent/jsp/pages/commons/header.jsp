		...
		<nav class="navbar navbar-static-top">
			...
			navbar-custom-menu">
        		<div class="top-nav dropdown">
            		...
            		<%
	                    long aid=adminDO.getAdminId();%>
    	               <%--  int imgStatus=adminDO.getImage_status();%>
					<%	if(imgStatus==1){ %>
						<a class="dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="color:#333;">
							<div class="pull-left image" id="profile-container">
								<img  id="profileImage" class="img-circle mt-5" style="width:40px;height:40px;" src="http://localhost:8080/profile_pics/<%=aid%>.jpg" alt="User Image">
